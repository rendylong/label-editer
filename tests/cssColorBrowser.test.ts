...
const CORPUS = [
  ...
  ['color-mix(in srgb, transparent 100%, red min(0%, 1%))', true],
  ['color-mix(in srgb, transparent 100%, red max(0%, 0%))', true],
  ['color-mix(in srgb, transparent 100%, red clamp(0%, 0%, 1%))', true],
  ['color-mix(in srgb, transparent 100%, red min(calc(0deg / 1deg * 1%), 1%))', true],
  ['color-mix(in srgb, transparent 100%, red calc(1% + -1%))', true],
  ['color-mix(in srgb, transparent 100%, red calc(1% /**/- 1%))', true],
  ['color-mix(in srgb, transparent 100%, red calc(1% -/**/ 1%))', true],
  ...
  ['color-mix(in srgb, transparent 100%, red calc(1%- 1%))', false],
  ['color-mix(in srgb, transparent 100%, red calc(1% -1%))', false],
  ['color-mix(in srgb, transparent 100%, red calc(1%/**/- 1%))', false],
  ['color-mix(in srgb, transparent 100%, red calc(1%/**/+/**/-1%))', false],
